...
class LoginController extends FrontController
{
	...
	public function __construct()
	{
		...
		$this->maxAttempts = (int)config('larapen.core.login.maxAttempts', $this->maxAttempts);
		$this->decayMinutes = (int)config('larapen.core.login.decayMinutes', $this->decayMinutes);
	}
