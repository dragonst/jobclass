						...
						<div class="panel-group" id="accordion">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#companyPanel" data-toggle="collapse" data-parent="#accordion"> {{ t('Company Information') }} </a></h4>
								</div>
								<div class="panel-collapse collapse in" id="companyPanel">
									<div class="panel-body">
										<form name="employee" class="form-horizontal" role="form" method="POST" action="{{ lurl('account/employees') }}" enctype="multipart/form-data">
											{!! csrf_field() !!}
											<input name="panel" type="hidden" value="companyPanel">

											@include('account.employee._form')
