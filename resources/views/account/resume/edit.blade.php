						...
						<div class="panel-group" id="accordion">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#resumePanel" data-toggle="collapse" data-parent="#accordion"> {{ t('Resume') }} </a></h4>
								</div>
								<div class="panel-collapse collapse in" id="resumePanel">
									<div class="panel-body">
										<form name="resume" class="form-horizontal" role="form" method="POST" action="{{ lurl('account/resumes/' . $resume->id) }}" enctype="multipart/form-data">
											{!! csrf_field() !!}
