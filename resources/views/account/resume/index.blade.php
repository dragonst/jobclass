										...
										<td style="width:10%" class="action-td">
											<div>
												@if ($resume->user_id==$user->id)
													<p>
														<a class="btn btn-primary btn-xs" href="{{ lurl('account/resumes/' . $resume->id . '/edit') }}">
															<i class="fa fa-edit"></i> {{ t('Edit') }}
														</a>
													</p>
													<p>
														<a class="btn btn-danger btn-xs delete-action" href="{{ lurl('account/resumes/'.$resume->id.'/delete') }}">
