...
INSERT INTO `<<prefix>>subadmin1` VALUES (2743,'QA.08','QA','Madīnat ash Shamāl','Madinat ash Shamal',1);
INSERT INTO `<<prefix>>subadmin1` VALUES (2744,'QA.04','QA','Al Khawr','Al Khawr',1);
INSERT INTO `<<prefix>>subadmin1` VALUES (2745,'QA.09','QA','Baladīyat Umm Şalāl','Baladiyat Umm Salal',1);
INSERT INTO `<<prefix>>subadmin1` VALUES (2746,'QA.06','QA','Baladīyat ar Rayyān','Baladiyat ar Rayyan',1);
INSERT INTO `<<prefix>>subadmin1` VALUES (2747,'QA.01','QA','Baladīyat ad Dawḩah','Baladiyat ad Dawhah',1);
INSERT INTO `<<prefix>>subadmin1` VALUES (2748,'QA.10','QA','Al Wakrah','Al Wakrah',1);
INSERT INTO `<<prefix>>subadmin1` VALUES (2749,'QA.13','QA','Baladīyat az̧ Z̧a‘āyin','Baladiyat az Za`ayin',1);
...
INSERT INTO `<<prefix>>cities` VALUES (289813,'QA','Dukhān','Dukhan',25.4249,50.7823,'P','PPL','QA.06',NULL,7250,'Asia/Qatar',1,'2015-07-02 23:00:00','2015-07-02 23:00:00');
...
INSERT INTO `<<prefix>>cities` VALUES (289877,'QA','Ash Shayḩānīyah','Ash Shayhaniyah',25.3709,51.2226,'P','PPL','QA.06',NULL,8380,'Asia/Qatar',1,'2016-08-02 23:00:00','2016-08-02 23:00:00');
...
INSERT INTO `<<prefix>>cities` VALUES (290030,'QA','Doha','Doha',25.2793,51.5224,'P','PPLC','QA.01',NULL,344939,'Asia/Qatar',1,'2010-05-29 23:00:00','2010-05-29 23:00:00');
